...
<head>
 ...
 $query = "SELECT count(ques_id) AS count, answer FROM feedback where ques_id='$idc' and page_id='$id' GROUP BY answer";
...
<table width="" height=""  border="0" align="center" cellpadding="5" cellspacing="5" >
	  <tr>
			  <td>
			  <form style="float: left; text-align:left; margin:5px 5px;"action="chart.php" method="GET">
