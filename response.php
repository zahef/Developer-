...
$q=mysqli_query($conn,"select * from subject_master  where sem_id=".$result_para['sem_id']." and  batch_id=".$result_para['batch_id']." and division_id=".$result_para['division_id']." and f_id=".$f_id);
echo mysqli_error();
$myarray=array();
$str="";
